...
function logout() {
    ...
    try {
        window.location.replace("https://dakdan.github.io/it-technician-support/index.html"); // ใช้ replace เพื่อไม่ให้กด Back กลับมาได้
    } catch(e) {
        window.location.href = "https://dakdan.github.io/it-technician-support/index.html"; // Fallback กรณี Browser ไม่รองรับ replace
    }
}
